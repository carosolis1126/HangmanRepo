...
//  MultipleScreens
//
//  Created by Carolina Solis on 06/27/21.
//

import UIKit

class AnimalsViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func generateWord(_ sender: Any){
        ...
        dashes = [""]
        winorlose.text = ""
        let animArray = readtextfile(inputArray: initialArray, filename: "animals")//read words text file
        let translationArray = readtextfile(inputArray: initialTranslation,filename: "animalstranslation")//read translation text file
        print(animArray)
        ...
        hangmanimage.image = UIImage(named: "animals") //initial hangman image
