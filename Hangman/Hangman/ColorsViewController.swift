...
class ColorsViewController: UIViewController {
    ...
    @IBAction func generateWord(_ sender: Any){
        ...
        winorlose.text = ""
        i = 1
        let animArray = readtextfile(inputArray: initialArray, filename: "colors")//read words text file
        let translationArray = readtextfile(inputArray: initialTranslation,filename: "colorstranslation")//read translation text file
        print(animArray)
        ...
        hangmanimage.image = UIImage(named: "palette") //initial hangman image
