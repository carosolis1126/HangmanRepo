...
class CountriesViewController: UIViewController {
    ...
    @IBAction func generateWord(_ sender: Any){
        ...
        hangmanimage.image = UIImage(named: "countries") //initial hangman image
        ...
        let animArray = readtextfile(inputArray: initialArray, filename: "countries")//read words text file
        let translationArray = readtextfile(inputArray: initialTranslation,filename: "countriestranslation")//read translation text file
        print(animArray)
