...
//  HangmanGame
//
//  Created by Carolina Solis on 08/04/21.
//
...
class CapitalsViewController: UIViewController {
    ...
    var translatedword = "" //translation of word in spanish
    var correspondingcountry = "" //country corresponding to capital
    ...
    @IBAction func generateWord(_ sender: Any){
        ...
        hangmanimage.image = UIImage(named: "capitals") //initial hangman image
        ...
        let animArray = readtextfile(inputArray: initialArray, filename: "capitals")//read words text file
        let translationArray = readtextfile(inputArray: initialTranslation,filename: "capitalstranslation")//read translation text file
        let countriesArray = readtextfile(inputArray:initialCountriesArray,filename: "countries")
        ...
        let arrayword = Array(wordtoguess)
        translatedword = String(translationArray[randomnumber])
        print(translatedword) //translation of random word
        correspondingcountry = String(countriesArray[randomnumber])
        print(correspondingcountry)
        ...
        //checks if word to guess has 2 words
        var count = 0
        while count < arrayword.count - 1{
            if arrayword[count] == " "{
                dashes.insert(" ", at: count)
                dashes.remove(at: dashes.count - 1)
            }
            count += 1
        }
    ...
    @IBAction func A(_ sender: Any) {
        ...
        if letterArray.contains("a"){ //if user guesses letter correctly
            ...
            if !(stringdashes.contains("_")){
                ...
                displayCountry.text = correspondingcountry
            }
